cat("model{
  ...
  for( s in 1:nNonSummerSamples ){     
      for( r in 1:(nRivers) ){ 
        ps[1,nonSummerSamples[s],r,1]<-1-gamma[s,r]
        ps[1,nonSummerSamples[s],r,2]<-gamma[s,r]
        ps[1,nonSummerSamples[s],r,3]<-0
        ps[1,nonSummerSamples[s],r,4]<-0
        ps[2,nonSummerSamples[s],r,1]<-0
        ps[2,nonSummerSamples[s],r,2]<-phiYoy[s,r]
        ps[2,nonSummerSamples[s],r,3]<-0
        ps[2,nonSummerSamples[s],r,4]<-1-phiYoy[s,r]
        ps[3,nonSummerSamples[s],r,1]<-0
        ps[3,nonSummerSamples[s],r,2]<-0
        ps[3,nonSummerSamples[s],r,3]<-phiAdult[s,r]
        ps[3,nonSummerSamples[s],r,4]<-1-phiAdult[s,r]
      ...
      #Observation
        po[1,nonSummerSamples[s],r,1]<-0
        po[1,nonSummerSamples[s],r,2]<-1
        po[2,nonSummerSamples[s],r,1]<-pYoy[s,r]
        po[2,nonSummerSamples[s],r,2]<-1-pYoy[s,r]
        po[3,nonSummerSamples[s],r,1]<-pAdult[s,r]
        po[3,nonSummerSamples[s],r,2]<-1-pAdult[s,r]
        po[4,nonSummerSamples[s],r,1]<-0
        po[4,nonSummerSamples[s],r,2]<-1
      }#r
    }#s
  ...
  for( s in 1:nSummerSamples ){     
      for( r in 1:(nRivers) ){ 
        ps[1,summerSamples[s],r,1]<-1-gamma[s,r]
        ps[1,summerSamples[s],r,2]<-gamma[s,r]
        ps[1,summerSamples[s],r,3]<-0
        ps[1,summerSamples[s],r,4]<-0
        ps[2,summerSamples[s],r,1]<-0
        ps[2,summerSamples[s],r,2]<-0
        ps[2,summerSamples[s],r,3]<-phiYoy[s,r]
        ps[2,summerSamples[s],r,4]<-1-phiYoy[s,r]
        ps[3,summerSamples[s],r,1]<-0
        ps[3,summerSamples[s],r,2]<-0
        ps[3,summerSamples[s],r,3]<-phiAdult[s,r]
        ps[3,summerSamples[s],r,4]<-1-phiAdult[s,r]
      ...
      #Observation
        po[1,summerSamples[s],r,1]<-0
        po[1,summerSamples[s],r,2]<-1
        po[2,summerSamples[s],r,1]<-pYoy[s,r]
        po[2,summerSamples[s],r,2]<-1-pYoy[s,r]
        po[3,summerSamples[s],r,1]<-pAdult[s,r]
        po[3,summerSamples[s],r,2]<-1-pAdult[s,r]
        po[4,summerSamples[s],r,1]<-0
        po[4,summerSamples[s],r,2]<-1
      }#r
    }#s
